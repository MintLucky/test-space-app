...
const Card = ({ title, subtitle, image, isBig = false }) => {
  return (
    <div
      className="card"
      style={{
        backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(15, 20, 32, 0.79) 100%), url(${image})`,
      }}
    >
      <div className="card__content">
        <h3 className={"card__title " + (isBig ? "card__title--big" : "")}>
          {title}
        </h3>
        <p className={"card__subtitle " + (isBig ? "card__subtitle--big" : "")}>
          {subtitle}
        </p>
    ...
    <div className="app">
      <header className="header">
        <div className="header__content-wrapper container">
          ...
          <button
            className={
              "burger-menu " + (isMenuOpened ? " burger-menu--open" : "")
            }
      ...
      <section className="journey container">
        ...
        <p className="journey__text">
          ...
          ready to help you make this dream come true. Our space tourism program
          offers a unique opportunity to see the Earth from a height of several
          hundred kilometers and feel that every moment is spent with incredible
          impressions. Experience and see for yourself! Our ship is equipped
          with the most modern technology and comfort so that you can fully
          enjoy your adventure in space. We offer several different tour
          packages that will suit the needs of both beginners and experienced
          space travelers.
        </p>
